...
-- CreateIndex
CREATE UNIQUE INDEX "conversations_users_user_id_conversation_id_key" ON "conversations_users"("user_id", "conversation_id");
...
-- AddForeignKey
ALTER TABLE "conversations_users" ADD CONSTRAINT "conversations_users_conversation_id_fkey" FOREIGN KEY ("conversation_id") REFERENCES "conversations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "pictures" ADD CONSTRAINT "tweet_picture" FOREIGN KEY ("entity_id") REFERENCES "tweets"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pictures" ADD CONSTRAINT "message_picture" FOREIGN KEY ("entity_id") REFERENCES "messages"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "voices" ADD CONSTRAINT "message_voice" FOREIGN KEY ("entity_id") REFERENCES "messages"("id") ON DELETE CASCADE ON UPDATE CASCADE;
